...
import { Revenue as IRevenue } from "@/interfaces/revenue";
...
export default function RevenuePage() {
  ...
  const { revenue, loading, error, removeRevenue, refetch} = useRevenue(token);
        ...
        <ul className="space-y-2">
          {!revenue || revenue.length === 0 ? (
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {[...revenue] // copia para não mutar o estado original
                  ...
                  <tr key={rev.id} className="border-b">
                    ...
                    <td className="text-right">
                      <Trash
                        ...
                        removeRevenue(Number(rev.id)).then(() => refetch()) : 
                        null}
                      />
                    </td>
                  </tr>
